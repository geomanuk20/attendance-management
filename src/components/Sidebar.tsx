...
export function Sidebar({
      ...
      <div className="p-5 border-b border-border flex items-center justify-between">
        ...
        {onMobileClose && (
          <Button
            ...
            className="lg:hidden h-8 w-8 rounded-full text-muted-foreground hover:text-foreground cursor-pointer"
        ...
        {menuItems.map((item) => {
          ...
          return (
            <Button
              ...
              className={`w-full justify-start gap-3 h-10 px-3.5 text-sm font-medium transition-all cursor-pointer ${
                isActive
  ...
  return (
    <>
      {/* Desktop Sidebar (hidden on mobile and tablet, visible on lg+) */}
      <aside className="w-64 border-r border-border h-screen flex flex-col shrink-0 hidden lg:flex">
        {sidebarContent}
      </aside>
