  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <header className="md:hidden flex items-center justify-between px-4 h-14 bg-card border-b border-border shrink-0 z-30">
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-card/95 backdrop-blur-md border-t border-border z-40 flex items-center justify-around px-2 shadow-lg">
          ...
          <button
            onClick={() => setIsMobileMenuOpen(true)}
            className="flex flex-col items-center justify-center flex-1 h-full py-1 gap-1 text-muted-foreground hover:text-foreground transition-colors"
          >
